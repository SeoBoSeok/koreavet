...
(function ($) {
    ...
    //Check header exist
    if ($header.length > 0) {
        var $headerOffsetTop = $header.offset().top || $header.height(); // $header.height()추가
    }
    ...
    INSPIRO.header = {
        ...
        stickyHeader: function () {
            ...
            var elem = $(this),
                ...
                shrinkHeaderActive = elem.attr('data-sticky-active') || 0, // 200
                ...
                var t = setTimeout(function () {
                    $widget_twitter.each(function () {
                        var $elem = $(this),
                            ...
                            twitterApiPAth = $elem.attr('data-loader') || "../js/polo/include/twitter/tweet.php",
